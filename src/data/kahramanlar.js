/**
 * Ilham veren kisiler ve kisa hikayeler. v1'in heroes_list.js'inden
 * tasindi (bilim, uzay, teknoloji, yapay zeka, doga, tarih). Bu bir VERI
 * dosyasidir; isimler burada bulunabilir (data/, mimari kisi-adi yasaginin
 * disinda). Alanlar: name, title, emoji, story, quote, lesson.
 */
...
export function kahramanSayisi() {
  return KAHRAMANLAR.length;
}
